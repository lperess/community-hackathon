...
import campusPartyBanner from "../../assets/cpbsb.png";
  ...
  return (
    <section className="forum-container">
      ...
      <div className="nav-container">
        <nav className="nav-page">
          ...
          <div className="navbar-icons">
            ...
            <select className="select-navbar">
              <option value="">Criados X Uhull</option>
            </select>
          </div>
        </nav>
        ...
        <h1 className="h1-class">Explore Temas</h1>
        ...
        <div className="cards-container">
          <div className="card-unidade">
            <img src={campusPartyBanner} alt="Logo da campus party" />
            <h1>Uhull</h1>
            <h2>Nivel 80</h2>
          </div>
          <div className="card-unidade">
